...
'''
os.system(
    "nvcc -DDEBUG -DPARAMS  src/attention.cpp src/kernel/math.cu src/forward/Kernel/layer_norm.cu src/forward/Kernel/embedding.cu src/backpropagation/Kernel/interface_back.cu -o src/bin/attention"
)
...
'''
os.system(
    "nvcc -DDEBUG -DDRUN src/attention.cpp src/kernel/math.cu src/forward/Kernel/layer_norm.cu src/forward/Kernel/embedding.cu src/backpropagation/Kernel/interface_back.cu -o src/bin/attention"
)
